...
def parse_arguments():
    ...
    parser.add_argument('--test_video_feats_path', default='video_feats2.pkl',
                        help='MIntRec2.0 test features inside video_data.')
    parser.add_argument('--test_audio_feats_path', default='audio_feats2.pkl',
                        help='MIntRec2.0 test features inside audio_data.')
