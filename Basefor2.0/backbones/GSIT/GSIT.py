...
class GsiT(nn.Module):
    def __init__(self, args):
        ...
        # 输入音频特征的维度
        audio_temp_dim_in  = args.audio_feat_dim
        # audio_temp_dim_out = self_super_cfg.a_feat_out

        video_temp_dim_in  =  args.video_feat_dim
        # video_temp_dim_out = self_super_cfg.v_feat_out

        # TEMPORAL CONVOLUTION LAYERS
        proj_dim = cmg_cfg.dst_feature_dim_nheads
        ...
        a_len, v_len = args.audio_seq_len, args.video_seq_len
    ...
    def forward(self, text, audio, video, plt=None):
        ...
        # 需要文本特征编码之前的内容input_ids, input_mask, segment_ids
